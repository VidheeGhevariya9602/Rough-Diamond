    ...
    return (
        <>
            ...
            <div className="report-con">
                ...
                <div className="row report-p1">
                    <div className="col-4 report-p2 p4">Rough | Natural Cognac</div>
                ...
                <div className="row report-p1">
                    <div className="col-4 report-p2 p4">Rough Octahedron | Natural Brown</div>
                ...
                <div className="row report-p1">
                    <div className="col-4 report-p2 p4">Rough Cube | Natural Dark Grey</div>
                ...
                <div className="row report-p1">
                    <div className="col-4 report-p2 p4">Rough | Natural Peppered White</div>
            ...
            <div className="report-con">
                ...
                <div className="row report-p1">
                    <div className="col-4 report-p2 p4">Rough | Natural Champagne</div>
            ...
            <div className="report-con">
                ...
                <div className="row report-p1">
                    <div className="col-4 report-p2 p4">Rough | Natural Grey, with Yellow Hint</div>
